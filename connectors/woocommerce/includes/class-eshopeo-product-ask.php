 ...
 * button) and registers the [eshopeo_ask_ai product_id="123"] shortcode.
 *
 * Clicking the button opens the eShopeo chat widget pre-seeded with the product
 * name so the customer can immediately ask about that product.
 */
class Eshopeo_Product_Ask {
    ...
    /**
     * [eshopeo_ask_ai product_id="123"] shortcode.
    ...
    public static function shortcode( array $atts ): string {
        ...
        $atts = shortcode_atts( [ 'product_id' => '' ], $atts, 'eshopeo_ask_ai' );
    ...
    private static function _button_html( string $product_name ): string {
        ...
        <button
            type="button"
            class="eshopeo-ask-ai-btn button alt"
            ...
            onclick="(function(){
                ...
                if (!p) { console.warn('[eShopeo] Widget not loaded'); return; }
                /* Open the panel */
