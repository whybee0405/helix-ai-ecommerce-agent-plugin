...
/**
 * Helix_Alt_Text — scan for images missing alt text and generate via AI.
 */
class Helix_Alt_Text {

    /* ── Init ──────────────────────────────────────────────────────────────── */

    public static function init(): void {
        add_action( 'wp_ajax_helix_alt_text_scan',         [ __CLASS__, 'ajax_scan' ] );
        add_action( 'wp_ajax_helix_alt_text_generate_one', [ __CLASS__, 'ajax_generate_one' ] );
    }
