...
class Eshopeo_Error_Log {
    ...
    public static function init(): void {
        add_action( 'wp_ajax_eshopeo_get_error_log',   [ __CLASS__, 'ajax_get' ] );
        add_action( 'wp_ajax_eshopeo_clear_error_log', [ __CLASS__, 'ajax_clear' ] );
    }
    ...
    public static function ajax_clear(): void {
        ...
        $snap_id    = Eshopeo_Snapshot::save( 'clear_error_log', [
            'path'  => $path,
            'lines' => $last_lines,
        ] );
