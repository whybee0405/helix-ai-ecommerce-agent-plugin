...
class Helix_Branding {
    ...
    public static function render_page(): void {
        ...
        /* ── Helix Branding Page ── */
        .helix-branding-page *,
        .helix-branding-page *::before,
        .helix-branding-page *::after { box-sizing: border-box; }
        ...
        @media (max-width: 782px) {
            .helix-branding-page { padding: 16px 12px 40px; }
        ...
        <div class="helix-branding-page">
            ...
            <div class="hbp-header">
                <h1>
                    ...
                    Helix Branding
                    <span class="hbp-badge">Helix AI</span>
                </h1>
            </div>

        <?php if ( ! get_option( 'helix_tenant_id' ) ) : ?>
            <div class="hbp-gated">
                ...
                <p>Connect your store in the Helix settings first before configuring branding.</p>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=helix-connector' ) ); ?>" class="hbp-btn hbp-btn-primary">Go to Settings &rarr;</a>
            </div>
        </div>
        <?php return; endif; ?>
        ...
        <?php if ( ! self::ensure_admin_secret() ) : ?>
            <div class="hbp-notice error">
                ...
                Could not bootstrap admin credentials. Check your Helix API URL and Provision Key.
            </div>
        </div>
        <?php return; endif; ?>
            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                            ...
                            <div class="hbp-field-row">
                                ...
                                <div class="hbp-control">
                                    <div class="hbp-logo-row">
                                        ...
                                        <img id="helix-logo-preview" class="hbp-logo-preview<?php echo $av ? ' has-image' : ''; ?>"
                                             src="<?php echo esc_url( $av ); ?>" alt="Logo preview">
                                        <div>
                                            <input type="url" name="avatar_url" id="helix_avatar_url" value="<?php echo esc_attr( $av ); ?>" class="hbp-input" placeholder="https://..." style="margin-bottom:8px;">
                                            <button type="button" class="hbp-btn hbp-btn-secondary" id="helix_pick_logo">
                                    ...
                                    <p class="hbp-desc">Leave blank to use the default Helix gradient avatar.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="hbp-section-body">
                        <div class="hbp-color-grid">
                            <div class="hbp-color-item">
                                ...
                                <input type="text" name="primary_color" id="hbp-primary" value="<?php echo esc_attr( $branding['primary_color'] ?? '#7C3AED' ); ?>" class="helix-color hbp-input narrow">
                            </div>
                            <div class="hbp-color-item">
                                <label for="hbp-secondary">Secondary</label>
                                <input type="text" name="secondary_color" id="hbp-secondary" value="<?php echo esc_attr( $branding['secondary_color'] ?? '#4F46E5' ); ?>" class="helix-color hbp-input narrow">
                            </div>
                            <div class="hbp-color-item">
                                <label for="hbp-accent">Accent</label>
                                <input type="text" name="accent_color" id="hbp-accent" value="<?php echo esc_attr( $branding['accent_color'] ?? '#C7B8F5' ); ?>" class="helix-color hbp-input narrow">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hbp-section">
                    <div class="hbp-section-head">
                        ...
                        <button type="button" class="hbp-btn hbp-btn-secondary" id="helix-add-chip">
                    ...
                    <div class="hbp-section-body">
                        <table class="hbp-chips-table" id="helix-chips-table">
                            <thead>
                                <tr>
                ...
                <div class="hbp-section">
                    ...
                    <div class="hbp-form-actions">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=helix-connector' ) ); ?>" class="hbp-btn hbp-btn-secondary">
                            &larr; Settings
                        </a>
                    </div>
                </div>
        ...
        jQuery(function ($) {
            ...
            $('#helix_pick_logo').on('click', function (e) {
                ...
                frame.on('select', function () {
                    ...
                    var preview = document.getElementById('helix-logo-preview');
            ...
            $('#helix_avatar_url').on('input', function () {
                var url = $(this).val();
                var preview = document.getElementById('helix-logo-preview');
                if (url) {
                    preview.src = url;
