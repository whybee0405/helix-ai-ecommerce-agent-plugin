...
class Eshopeo_Performance_Dash {

    /* ── Hooks ─────────────────────────────────────────────────────────── */

    public static function init(): void {
        add_action( 'wp_ajax_eshopeo_performance_metrics', [ __CLASS__, 'ajax_metrics' ] );
    }
    ...
    public static function collect(): array {
        ...
        $heartbeat_interval   = get_option( 'eshopeo_heartbeat_interval', 'default' );
