...
class Eshopeo_Rollback {

    /* ── Hooks ─────────────────────────────────────────────────────────── */

    public static function init(): void {
        add_action( 'wp_ajax_eshopeo_action_rollback', [ __CLASS__, 'ajax_rollback' ] );
    }
    ...
    public static function ajax_rollback(): void {
        ...
        $snapshot = Eshopeo_Snapshot::get( $snapshot_id );
        if ( null === $snapshot ) {
        ...
        Eshopeo_Snapshot::delete( $snapshot_id );
    ...
    private static function rollback_set_heartbeat( array $snapshot ): array|WP_Error {
        ...
        update_option( 'eshopeo_heartbeat_interval', $old_value, false );
    ...
    private static function rollback_disable_heartbeat_frontend( array $snapshot ): array|WP_Error {
        ...
        update_option( 'eshopeo_disable_heartbeat_frontend', $old_value, false );
        return [ 'affected' => 1, 'restored_value' => $old_value ];
    }
}
