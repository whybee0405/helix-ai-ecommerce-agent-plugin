...
/**
 * Eshopeo_Image_Optimiser — convert images to WebP via Imagick on upload.
 */
class Eshopeo_Image_Optimiser {
    ...
    public static function init(): void {
        ...
        add_action( 'wp_ajax_eshopeo_image_scan',            [ __CLASS__, 'ajax_scan' ] );
        add_action( 'wp_ajax_eshopeo_image_optimise_batch',  [ __CLASS__, 'ajax_optimise_batch' ] );
    }
