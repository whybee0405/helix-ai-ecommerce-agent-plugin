...
/**
 * Eshopeo_SEO_Meta — scan posts missing SEO meta and generate via AI.
 */
class Eshopeo_SEO_Meta {

    /* ── Init ──────────────────────────────────────────────────────────────── */

    public static function init(): void {
        add_action( 'wp_ajax_eshopeo_seo_scan',         [ __CLASS__, 'ajax_scan' ] );
        add_action( 'wp_ajax_eshopeo_seo_generate_one', [ __CLASS__, 'ajax_generate_one' ] );
    }
