...
/**
 * Helix_Blog_Generator — AI-powered blog post generation.
 */
class Helix_Blog_Generator {

    /* ── Init ──────────────────────────────────────────────────────────────── */

    public static function init(): void {
        add_action( 'wp_ajax_helix_blog_generate', [ __CLASS__, 'ajax_generate' ] );
    }
    ...
    public static function ajax_generate(): void {
        ...
        $response = wp_remote_post(
            trailingslashit( $api_url ) . 'v1/blog/generate',
            [
                'timeout' => 90,
                'headers' => [
