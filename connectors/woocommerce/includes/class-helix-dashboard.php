...
class Helix_Dashboard {
    ...
    private static function render_header( string $title, string $active ): void {
        ...
        <div class="hx-topbar">
            <h1>
                ...
                <span class="hx-badge">Helix AI</span>
            </h1>
            <nav class="hx-nav">
                ...
                <?php endforeach; ?>
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=helix-connector' ) ); ?>" class="settings-link">
    ...
    private static function not_connected(): void {
        ...
        <div class="hx-no-connect">
            ...
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=helix-connector' ) ); ?>" class="hx-btn hx-btn-primary">Go to Settings</a>
        </div>
        <?php
    }
    ...
    public static function render_dashboard(): void {
        ...
        <div class="hx-section">
            <div class="hx-section-head">
                ...
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=helix-conversations' ) ); ?>" class="hx-section-link">View all &rarr;</a>
            </div>
