    ...
    public static function render(): void {
            ...
            <div id="hwpa-panel-performance" class="hwpa-panel" role="tabpanel">
                ...
                <div class="hwpa-card" id="hwpa-vitals-card">
                    ...
                    <div class="hwpa-card-body" id="hwpa-vitals-body">
                        <p style="color:#9ca3af;font-size:13px;">Requires a PageSpeed API key in Helix Settings. Click "Scan Now" to run.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="hwpa-card-body">
                        <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;margin-bottom:14px;">
                            ...
                            <select id="hwpa-bk-schedule" style="border:1px solid #e5e7eb;border-radius:6px;padding:5px 10px;font-size:13px;">
                                <option value="daily" <?php selected( get_option( 'helix_backup_schedule', 'daily' ), 'daily' ); ?>>Daily</option>
                                <option value="weekly" <?php selected( get_option( 'helix_backup_schedule', 'daily' ), 'weekly' ); ?>>Weekly</option>
                                <option value="off" <?php selected( get_option( 'helix_backup_schedule', 'daily' ), 'off' ); ?>>Off</option>
                            </select>
                            <label style="font-size:13px;font-weight:500;">Keep last:</label>
                            <input type="number" id="hwpa-bk-keep" value="<?php echo esc_attr( get_option( 'helix_backup_keep', 7 ) ); ?>" min="1" max="30" style="width:60px;border:1px solid #e5e7eb;border-radius:6px;padding:5px 8px;font-size:13px;">
                        </div>
        ...
        (function () {
            ...
            (function () {
                ...
                function loadUptime() {
                    ajaxPost('helix_uptime_data', {}, function (res) {
            ...
            (function () {
                ...
                document.getElementById('hwpa-vitals-scan').addEventListener('click', function () {
                    ...
                    ajaxPost('helix_web_vitals_scan', { force: '1' }, function (res) {
            ...
            (function () {
                ...
                function scanBatch(offset) {
                    ajaxPost('helix_scan_broken_links', { offset: offset, batch: 20, force: '1' }, function (res) {
                        if (!res.success) {
                ...
                function renderBrokenLinks() {
                    ...
                    blResults.querySelectorAll('.hwpa-bl-fix-btn').forEach(function (btn) {
                        btn.addEventListener('click', function () {
                            ...
                            if (!newUrl) return;
                            btn.disabled = true;
                            ajaxPost('helix_broken_links_fix', { post_id: btn.dataset.postId, old_url: btn.dataset.oldUrl, new_url: newUrl }, function (res) {
                                if (res.success) {
            ...
            (function () {
                ...
                function loadErrorLog(level) {
                    ...
                    ajaxPost('helix_get_error_log', { level: level || '' }, function (res) {
                ...
                document.getElementById('hwpa-el-clear').addEventListener('click', function () {
                    ...
                    elSpinner.style.display = 'inline-block';
                    ajaxPost('helix_clear_error_log', {}, function (res) {
                        elSpinner.style.display = 'none';
            ...
            (function () {
                ...
                function loadBackups() {
                    ajaxPost('helix_list_backups', {}, function (res) {
                        ...
                        bkResults.querySelectorAll('.hwpa-bk-dl').forEach(function (btn) {
                            btn.addEventListener('click', function () {
                                ...
                                ['action','nonce','filename'].forEach(function (k) {
                                    ...
                                    i.value = k === 'action' ? 'helix_download_backup' : (k === 'nonce' ? NONCE : btn.dataset.fn);
                                    form.appendChild(i);
                                });
                        ...
                        bkResults.querySelectorAll('.hwpa-bk-del').forEach(function (btn) {
                            btn.addEventListener('click', function () {
                                ...
                                ajaxPost('helix_delete_backup', { filename: btn.dataset.fn }, function (res) {
                ...
                document.getElementById('hwpa-bk-run').addEventListener('click', function () {
                    ...
                    ajaxPost('helix_run_backup', {}, function (res) {
                        btn.disabled = false;
            ...
            (function () {
                ...
                function loadPlugins() {
                    ...
                    ajaxPost('helix_list_plugins', {}, function (res) {
                ...
                function renderPlugins() {
                    ...
                    pmResults.querySelectorAll('.hwpa-pm-toggle').forEach(function (cb) {
                        cb.addEventListener('change', function () {
                            cb.disabled = true;
                            ajaxPost('helix_toggle_plugin', { plugin_file: cb.dataset.file, activate: cb.checked ? '1' : '0' }, function (res) {
                                cb.disabled = false;
                    ...
                    pmResults.querySelectorAll('.hwpa-pm-update-btn').forEach(function (btn) {
                        btn.addEventListener('click', function () {
                            ...
                            ajaxPost('helix_update_plugin', { plugin_file: btn.dataset.file }, function (res) {
                ...
                document.getElementById('hwpa-pm-update-all').addEventListener('click', function () {
                    ...
                    function updateNext() {
                        ...
                        ajaxPost('helix_update_plugin', { plugin_file: updates[i].file }, function () { i++; updateNext(); });
                    }
                    updateNext();
                });
            ...
            (function () {
                ...
                function loadSnippets() {
                    ajaxPost('helix_snippets_list', {}, function (res) {
                ...
                function attachSnippetHandlers(snippets) {
                    snList.querySelectorAll('.hwpa-sn-toggle').forEach(function (cb) {
                        cb.addEventListener('change', function () {
                            ajaxPost('helix_snippets_toggle', { id: cb.dataset.id, enabled: cb.checked ? '1' : '0' }, function (res) {
                    ...
                    snList.querySelectorAll('.hwpa-sn-del-btn').forEach(function (btn) {
                        btn.addEventListener('click', function () {
                            ...
                            ajaxPost('helix_snippets_delete', { id: btn.dataset.id }, function (res) {
                ...
                function openSnippetModal(snippet) {
                    ...
                    overlay.querySelector('#hwpa-sn-save').addEventListener('click', function () {
                        ...
                        ajaxPost('helix_snippets_save', data, function (res) {
            ...
            (function () {
                ...
                function loadAlt() {
                    ...
                    ajaxPost('helix_alt_text_scan', {}, function (res) {
                ...
                function renderAlt() {
                    ...
                    atResults.querySelectorAll('.hwpa-at-gen-one').forEach(function (btn) {
                        btn.addEventListener('click', function () {
                            ...
                            ajaxPost('helix_alt_text_generate_one', { attachment_id: btn.dataset.id }, function (res) {
                ...
                document.getElementById('hwpa-at-gen-all').addEventListener('click', function () {
                    ...
                    function genNext() {
                        ...
                        ajaxPost('helix_alt_text_generate_one', { attachment_id: atItems[i].id }, function () { i++; genNext(); });
                    }
                    genNext();
                });
            ...
            (function () {
                ...
                function loadSeo() {
                    ...
                    ajaxPost('helix_seo_scan', {}, function (res) {
                ...
                function renderSeo() {
                    ...
                    smResults.querySelectorAll('.hwpa-sm-gen-one').forEach(function (btn) {
                        btn.addEventListener('click', function () {
                            btn.disabled = true; btn.textContent = '…';
                            ajaxPost('helix_seo_generate_one', { post_id: btn.dataset.id }, function (res) {
                ...
                document.getElementById('hwpa-sm-gen-all').addEventListener('click', function () {
                    ...
                    function genNext() {
                        ...
                        ajaxPost('helix_seo_generate_one', { post_id: smItems[i].ID }, function () { i++; genNext(); });
                    }
                    genNext();
                });
            ...
            (function () {
                ...
                function loadProducts() {
                    ajaxPost('helix_reviews_get_products', {}, function (res) {
                ...
                rvSynth.addEventListener('click', function () {
                    ...
                    ajaxPost('helix_reviews_synthesise', { product_id: pid }, function (res) {
            ...
            (function () {
                ...
                document.getElementById('hwpa-il-suggest').addEventListener('click', function () {
                    ...
                    ajaxPost('helix_internal_links_suggest', { post_id: pid }, function (res) {
                        ...
                        ilResults.querySelectorAll('.hwpa-il-apply').forEach(function (btn) {
                            btn.addEventListener('click', function () {
                                btn.disabled = true;
                                ajaxPost('helix_internal_links_apply', { post_id: btn.dataset.pid, anchor_text: btn.dataset.anchor, target_url: btn.dataset.url }, function (res) {
                                    if (res.success) {
                        ...
                        ilResults.querySelectorAll('.hwpa-il-undo').forEach(function (btn) {
                            btn.addEventListener('click', function () {
                                ...
                                ajaxPost('helix_action_rollback', { snapshot_id: btn.dataset.snap }, function (res) {
            ...
            (function () {
                ...
                function loadDescriptions() {
                    ...
                    ajaxPost('helix_desc_scan', {}, function (res) {
                        ...
                        pdResults.querySelectorAll('.hwpa-pd-rewrite').forEach(function (btn) {
                            btn.addEventListener('click', function () {
                                btn.disabled = true; btn.textContent = '…';
                                ajaxPost('helix_desc_rewrite_one', { product_id: btn.dataset.id }, function (res) {
                                    if (res.success) {
            ...
            (function () {
                ...
                document.getElementById('hwpa-rp-generate').addEventListener('click', function () {
                    ...
                    ajaxPost('helix_repurpose', { post_id: pid, formats: formats.join(',') }, function (res) {
            ...
            (function () {
                ...
                function loadImages() {
                    ...
                    ajaxPost('helix_image_scan', {}, function (res) {
                ...
                function renderImages() {
                    ...
                    ioResults.querySelectorAll('.hwpa-io-opt-one').forEach(function (btn) {
                        btn.addEventListener('click', function () {
                            btn.disabled = true; btn.textContent = '…';
                            ajaxPost('helix_image_optimise_batch', { attachment_ids: [btn.dataset.id] }, function (res) {
                ...
                document.getElementById('hwpa-io-opt-all').addEventListener('click', function () {
                    ...
                    function nextBatch() {
                        ...
                        ajaxPost('helix_image_optimise_batch', { attachment_ids: batches[bi].join(',') }, function () { bi++; nextBatch(); });
                    }
                    nextBatch();
                });
            ...
            (function () {
                ...
                digestBtn.addEventListener('click', function () {
                    ...
                    ajaxPost('helix_digest_send_test', { email: email }, function (res) {
