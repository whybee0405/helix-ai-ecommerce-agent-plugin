...
class Eshopeo_Plugin_Manager {

    /* ── Init ──────────────────────────────────────────────────────────── */

    public static function init(): void {
        add_action( 'wp_ajax_eshopeo_list_plugins',   [ __CLASS__, 'ajax_list' ] );
        add_action( 'wp_ajax_eshopeo_update_plugin',  [ __CLASS__, 'ajax_update' ] );
        add_action( 'wp_ajax_eshopeo_toggle_plugin',  [ __CLASS__, 'ajax_toggle' ] );
    }
    ...
    public static function ajax_update(): void {
        ...
        $snap_id = Eshopeo_Snapshot::save( 'plugin_update_' . sanitize_key( $plugin_file ), [
    ...
    public static function ajax_toggle(): void {
        ...
        // Snapshot state.
        $snap_id = Eshopeo_Snapshot::save( 'plugin_toggle_' . sanitize_key( $plugin_file ), [
            'plugin_file' => $plugin_file,
