...
from eshopeo.branding import Branding
from eshopeo.config import Settings
from eshopeo.llm.cache import LLMCache
from eshopeo.llm.gateway import LLMGateway, RouteResult
from eshopeo.llm.semantic_cache import SemanticCache
...
async def _maybe_inject_web_search_context(
    ...
    try:
        from eshopeo.tools.web_search import brave_search
...
async def _maybe_inject_faq_context(
    ...
    try:
        ...
        from eshopeo.db.crud.faqs import vector_search_faqs
