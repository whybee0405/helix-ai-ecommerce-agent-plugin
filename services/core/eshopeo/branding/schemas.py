...
class Branding(BaseModel):
    ...
    brand_name: str = Field(default="eShopeo", min_length=1, max_length=60)
    brand_short_name: str = Field(default="eShopeo", min_length=1, max_length=30)
    ...
    sb_anim: str = "rainbow"     # "rainbow" | "pulse" | "brand" | "none" | "custom"
    sb_anim_css: str = ""        # only used when sb_anim == "custom"
