...
class LLMGateway:
    ...
    async def route_query(
        ...
        from eshopeo.llm.layers import TemplateLayer, RuleEngineLayer
        ...
        if semantic_cache is not None and not conversation_history:
            from eshopeo.llm.semantic_cache import ttl_for_intent
...
from eshopeo.llm.cache import LLMCache  # noqa: E402
