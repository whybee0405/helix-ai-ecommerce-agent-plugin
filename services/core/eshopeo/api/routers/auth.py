...
from eshopeo.api.auth.tokens import issue_access_token
from eshopeo.api.deps import get_dashboard_tenant, get_db
from eshopeo.billing.plans import PLANS
from eshopeo.branding.presets import get_preset
from eshopeo.config import get_settings
from eshopeo.db.crud.tenants import create_tenant, get_tenant_by_email, get_tenant_by_id
...
async def register(
    ...
    try:
        from eshopeo.notifications.email import send_welcome_email
...
async def request_magic_link(
    ...
    try:
        from eshopeo.notifications.email import send_magic_link_email
