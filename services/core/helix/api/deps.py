...
from helix.api.auth.tokens import InvalidTokenError, validate_access_token, validate_widget_token
...
async def check_ai_op_quota(
    ...
    from helix.billing.plans import get_ai_ops_limit
    ...
    if limit == 0:
        raise HTTPException(
            ...
            headers={"X-Helix-Upgrade": "required"},
        )
